...
//CODE HERE
const compareNums = (Thing1, Thing2) => {
if(Thing1 > Thing2){console.log(`${Thing1} is bigger`)}
else if(Thing1 < Thing2){console.log(`${Thing2}Is bigger`)}
else{return Thing1}
}
...
*/
const exclaimTwoLine = str => {return `${str.toUpperCase()}!!!`}
...
//CODE HERE
const favColorFinder = () => {
if(favColorFinder === 'red'){return 'red is the best color'}
else if(favColorFinder === 'green'){return 'green is a solid favorite color'}
else if(favColorFinder === 'black'){return 'so trendy'}
else{return 'you need to evaluate your favorite color choice'}

}
colorRating = favColorFinder('red')
...
//CODE HERE
const thatsOdd = (Dual) => {
  if(Dual % 2 === 0){return 'Thats not odd'}
  else{return 'That is odd indeed'}
}
console.log(thatsOdd(8))
...
function bigOrSmall(arr){
    ...
    for(let i = 0; i < arr.length; i++){
      if(arr[i] > 100){answers.push(arr[i])}
...
if(contestants[x] === loser){
  contestants.splice(x, 1)
...
const emailCheck = (email) => { 
 let hasAt = false
  let newstring = ((email.toString()).trim()).split('')
  
  for(let y = 0;y < email.length;y++){
  if(newstring[y] === '@'){hasAt = true}
  }
  if(hasAt === true){return 'email verified'}
  else{ return 'must provide a valid email address'}

}

console.log(emailCheck('itsazari9321@gmail.com'))
////////////////// PROBLEM 19 ////////////////////
/*
...
//CODE HERE
const FrogBuyer = (Money) => {
  return Money/3 
} 
totalFrogs = FrogBuyer(99)

////////////////// PROBLEM 20 ////////////////////
/*
  You might have noticed a slight bug in the previous problem. 
  If you were to pass in 4 gold, the function would return to you 1.3333... However, you can't really go to a store and by 1.333 products.
   ...
   nvoke the function and store the returned value to a variable called `totalFrogs2`.
*/
const FrogBuyer2 = (Money1) => {
return Math.floor(Money1/3) 
}
totalFrogs2 = FrogBuyer2(98)
console.log(totalFrogs2)
//CODE HERE


////////////////// PROBLEM 21 ////////////////////
let sampleArray = [0,1,2,3,4,5,9,8,9]
/*
  Write a function that takes in an array of numbers as an argument. In the body of the function, write logic to determine
   if the array is in ascending order. The function should return true, if it is sorted in ascending order, false if it is not. 
   Create a variable, `arrayIsAscending` and set it equal to your function invoked. Use the sample array to test this function.
*/
const BigCount = (array) => {
let ascending = false 
...
console.log(BigCount(sampleArray))
//CODE HERE
